...
export default function LandingScreen({ onEnterGame, onHowToPlay }: LandingScreenProps) {
  return (
    <div className="relative w-full h-screen overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 text-center space-y-8 animate-fade-in">
        ...
        <div className="space-y-4">
          <h1 className="text-8xl font-bold text-white drop-shadow-2xl tracking-wider font-serif">
            ARLAND
          </h1>
          <p className="text-2xl text-accent drop-shadow-lg font-medium">
